		...
		<div class="d-flex justify-content-center">
 			...
 			<div class="hyou
				...
				<div class="mb-2">
  				...
  				<div class="d-flex justify-content-center">
  					<input type="text" name="daimei" class="form-control w-75" id="FormControlInput1">
				</div>
				...
				<div>
 				 ...
 				 <div class="d-flex justify-content-center">
 				 	<textarea name="honbun" class="form-control w-75" id="FormControlTextarea1" placeholder="本文を入力してください" rows="10"></textarea>
				</div>
				
				<div class="d-flex justify-content-end">
					<button type="submit" class="btn btn-secondary">メモる</button>
				</div>
